...
<table class="table" style="border-spacing:1px">
    ...
    <tbody>
      ...
      @foreach($placed_item as $placed_items)
      <tr>
        ...
        <td scope="col">{{$placed_items->item->item}}</td>
        <td scope="col">{{$placed_items->item->price}}</td>
        <td scope="col"><img src="{{asset('image/'.$placed_items->item->image )}}" width="100"></td>
        <td scope="col">{{$placed_items->item->category->name}}</td>
