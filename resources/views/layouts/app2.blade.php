...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('assets/css/newprofile.css')}}">
  ...
  <body class="c-app">
    {{-- <div class="c-sidebar c-sidebar-dark c-sidebar-fixed c-sidebar-lg-show" id="sidebar">
      ...
      <ul class="c-sidebar-nav">
        ...
        <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" @yield('logout')>
            <svg class="c-sidebar-nav-icon">
              <use xlink:href="node_modules/@coreui/icons/sprites/free.svg#cil-drop"></use>
            </svg> Logout</a></li>
        <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" @yield('editprofile')>
            <svg class="c-sidebar-nav-icon">
              <use xlink:href="node_modules/@coreui/icons/sprites/free.svg#cil-pencil"></use>
            </svg> Edit Profile</a></li>

        <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" @yield('additem')>
              <svg class="c-sidebar-nav-icon">
                <use xlink:href="node_modules/@coreui/icons/sprites/free.svg#cil-pencil"></use>
              </svg> Add Item</a></li>

        <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" @yield('showitemtable')>
              <svg class="c-sidebar-nav-icon">
                  <use xlink:href="node_modules/@coreui/icons/sprites/free.svg#cil-pencil"></use>
              </svg> Show Item Table</a></li>
        
        <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" @yield('itemcategory')>
              <svg class="c-sidebar-nav-icon">
                    <use xlink:href="node_modules/@coreui/icons/sprites/free.svg#cil-pencil"></use>
              </svg> Add Item Category</a></li>
    ...
    <div class="c-wrapper c-fixed-components">
      <header class="c-header c-header-light c-header-fixed c-header-with-subheader">
        ...
        <ul class="c-header-nav d-md-down-none">
          ...
          <li class="c-header-nav-item px-3"><a class="c-header-nav-link" href="{{asset('profile/itemtable')}}">Settings</a></li>
        </ul>
        ...
        <div class="c-subheader px-3">
          ...
          <ol class="breadcrumb border-0 m-0">
            ...
            <li class="breadcrumb-item"><a href="{{asset('profile')}}">Admin</a></li>
